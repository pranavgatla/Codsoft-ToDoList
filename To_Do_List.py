...
class ToDoListApp:
    def __init__(self, root):
        ...
        self.tasks = []
        self.heading = tkn.Label(self.root, text="TO DO LIST", font=("Eras Bold Itc", 17), bg="yellow")
        ...
        self.priorityLabel = tkn.Label(self.listFrm, text="Sl no.", width=10, anchor='w')
        self.priorityLabel.grid(row=0, column=0)

        self.taskLabel = tkn.Label(self.listFrm, text="Name of the Task", width=40, anchor='w')
        ...
        self.upBtn = tkn.Button(self.priorityPanel, text="↑", command=self.moveUp, bg="sky blue")
        self.upBtn.grid(row=0, column=0)

        self.downBtn = tkn.Button(self.priorityPanel, text="↓", command=self.moveDown, bg="sky blue")
